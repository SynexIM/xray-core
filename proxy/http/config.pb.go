...
type ServerConfig struct {
	...
	UserAccounts  []*UserAccount `protobuf:"bytes,5,rep,name=user_accounts,json=userAccounts,proto3" json:"user_accounts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClientConfig) Reset() {
	*x = ClientConfig{}
	mi := &file_proxy_http_config_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientConfig) Descriptor() ([]byte, []int) {
	return file_proxy_http_config_proto_rawDescGZIP(), []int{4}
}
...
const file_proxy_http_config_proto_rawDesc = "" +
	...
	"\x15committed_burst_bytes\x18\x06 \x01(\x04R\x13committedBurstBytes\"\xa3\x02\n" +
	"\fServerConfig\x12G\n" +
	...
	"\n" +
	"user_level\x18\x04 \x01(\rR\tuserLevel\x12A\n" +
	"\ruser_accounts\x18\x05 \x03(\v2\x1c.xray.proxy.http.UserAccountR\fuserAccounts\x1a;\n" +
...
var file_proxy_http_config_proto_goTypes = []any{
	...
	(*UserAccount)(nil),             // 1: xray.proxy.http.UserAccount
...
var file_proxy_http_config_proto_depIdxs = []int32{
	...
	1, // 1: xray.proxy.http.ServerConfig.user_accounts:type_name -> xray.proxy.http.UserAccount
